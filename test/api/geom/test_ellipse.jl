...
# Mergin two meshes
e = VPL.Ellipse(l = 2.0, w = 2.0, n = 10);
e2 = VPL.Ellipse(l = 3.0, w = 0.1, n = 10);
function foo()
    e = VPL.Ellipse(l = 2.0, w = 2.0, n = 10)
    e2 = VPL.Ellipse(l = 3.0, w = 0.1, n = 10)
    m = VPL.Mesh([e,e2])
...
function foo2()
    scale = LinearMap(SDiagonal(1.0, 0.05, 1.5))
    m = VPL.Ellipse(l = 2.0, w = 2.0, n = 10)
