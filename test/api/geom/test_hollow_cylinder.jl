...
c = VPL.HollowCylinder(l = 2.0, w = 1.0, h = 1.0, n = 10);
@test c isa VPL.Mesh
...
c = VPL.HollowCylinder(l = 2f0, w = 1f0, h = 1f0, n = 10);
@test c isa VPL.Mesh
...
# Mergin two meshes
c = VPL.HollowCylinder(l = 2.0, w = 1.0, h = 1.0, n = 10);
c2 = VPL.HollowCylinder(l = 3.0, w = 0.1, h = 0.2, n = 10);
function foo()
    c = VPL.HollowCylinder(l = 2.0, w = 1.0, h = 1.0, n = 10);
    c2 = VPL.HollowCylinder(l = 3.0, w = 0.1, h = 0.2, n = 10);
    m = VPL.Mesh([c,c2])
...
c3 = VPL.HollowCylinder(scale,n = 10);
...
function foo2()
    scale = LinearMap(SDiagonal(0.2/2,0.1/2,3.0))
    m = VPL.HollowCylinder(l = 2.0, w = 1.0, h = 1.0, n = 10)
    VPL.Geom.HollowCylinder!(m, scale, n = 10)
    m
end
m2 = foo2();
...
hc = G.HollowCylinder(l = 2.0, w = 1.0, h = 1.0, n = 10);
t = G.MTurtle(Float64)
G.HollowCylinder!(t; l = 2.0, w = 1.0, h = 1.0, n = 10, move = true) 
@test G.geoms(t) == hc
@test G.pos(t) == G.Vec{Float64}(0,0,2)

t = G.MTurtle(Float64)
G.HollowCylinder!(t; l = 2.0, w = 1.0, h = 1.0, n = 10, move = false);
@test G.geoms(t) == hc
