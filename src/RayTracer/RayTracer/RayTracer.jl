...
pseudo-random number generator to be used by the ray tracer. See VPL documentation for more details on the ray tracer.
"""
...
Create a ray tracer object from an acceleration structure built around a 3D mesh (`acceleration`), a grid clonder structure around
