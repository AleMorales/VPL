...
c = VPL.SolidFrustum(l = 2.0, w = 1.0, h = 1.0, ratio = 0.5, n = 10);
@test c isa VPL.Mesh;
...
c = VPL.SolidFrustum(l = 2f0, w = 1f0, h = 1f0, ratio = 0.5f0, n = 10);
@test c isa VPL.Mesh;
exact_area = (pi + 0.5pi)/2*sqrt(2^2 + 0.25^2) + pi*(0.5^2 + 0.25^2)
...
# Mergin two meshes
c = VPL.SolidFrustum(l = 2.0, w = 1.0, h = 1.0, ratio = 0.5, n = 10);
c2 = VPL.SolidFrustum(l = 3.0, w = 0.1, h = 0.2, ratio = 1/10, n = 10);
function foo()
    c  = VPL.SolidFrustum(l = 2.0, w = 1.0, h = 1.0, ratio = 0.5, n = 10)
    c2 = VPL.SolidFrustum(l = 3.0, w = 0.1, h = 0.2, ratio = 1/10, n = 10)
    m = VPL.Mesh([c,c2])
...
c3 = VPL.SolidFrustum(1/10.0,scale,n = 10);
...
function foo2()
    scale = LinearMap(SDiagonal(0.2/2,0.1/2,3.0))
    m = VPL.SolidFrustum(l = 2.0, w = 1.0, h = 1.0, ratio = 0.5, n = 10)
    VPL.Geom.SolidFrustum!(m, 1/10,scale, n = 10)
    m
end
m2 = foo2();
...
sf = G.SolidFrustum(l = 2.0, w = 1.0, h = 1.0, ratio = 0.5, n = 10);
t = G.MTurtle(Float64)
G.SolidFrustum!(t; l = 2.0, w = 1.0, h = 1.0, ratio = 0.5, n = 10, move = true) 
@test G.geoms(t) == sf
@test G.pos(t) == G.Vec{Float64}(0,0,2)

t = G.MTurtle(Float64)
G.SolidFrustum!(t; l = 2.0, w = 1.0, h = 1.0, ratio = 0.5, n = 10, move = false);
@test G.geoms(t) == sf
